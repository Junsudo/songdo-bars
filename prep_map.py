...
PARTY_NOTES = {
    ...
    "째즈257": "자동 발굴: 재즈+와인바 154㎡, 단체·대관 언급 다수",
    "연금술사 송도점": "자동 발굴: 117㎡, 단체 언급 다수 (커낼워크)",
    "오늘와인한잔 송도트리플스트리트점": "자동 발굴: 와인포차 체인, 단체 언급 다수",
    "타펠 룬데 서울 송도점": "자동 발굴: 와인바 89㎡, 단체 언급 다수",
    "VIP": "자동 발굴: 칵테일바 122㎡ (대관 신호는 없음)",
}
PARTY_ONLY = {"더신더바", "탄트라", "다이어메이커", "홀리데이인인천송도 터치스카이루프탑바", "모나코", "126F&B", "카페에디토레"}
# 자동 발굴(미실사) — 파티 개연성 신호(칵테일·와인바·라운지·재즈·대형)로 추린 후보. 멤버 검증 전.
PARTY_AUTO = {"째즈257", "연금술사 송도점", "오늘와인한잔 송도트리플스트리트점", "타펠 룬데 서울 송도점", "VIP"}
